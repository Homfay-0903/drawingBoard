...
const Canvas = () => {
            ...
            switch (element.type) {
                ...
                case 'line':
                    ...
                    if (element.lineShape === 'arrow') {
                        drawArrow(ctx, x1, y1, x2, y2, element.stroke || strokeColor, element.strokeWidth || strokeWidth)
            ...
            if (drawingElement.type === 'rectangle') {
                rc.draw(
                    rc.rectangle(drawingElement.x, drawingElement.y, drawingElement.width, drawingElement.height, {
                        roughness: drawingElement.roughness || 2.5,
                        stroke: drawingElement.stroke || strokeColor,
                        strokeWidth: drawingElement.strokeWidth || strokeWidth
                    })
                )
            } else if (drawingElement.type === 'line') {
                if (drawingElement.lineShape === 'arrow') {
                    drawArrow(ctx, x1, y1, x2, y2, drawingElement.stroke || strokeColor, drawingElement.strokeWidth || strokeWidth)
                    ...
                    if (de.points && de.points.length) {
                        ...
                        rc.draw(rc.path(pathStr, {
                            ...
                            strokeWidth: de.strokeWidth || strokeWidth
                        }))
                    }
                } else {
    ...
    const handleMouseDown = (e: React.MouseEvent) => {
        ...
        const newElement: drawingBoardElements = {
            ...
            lineShape: lineShape,
            stroke: strokeColor,
            strokeWidth: strokeWidth, // 添加画笔粗细
